...
const ChartLegendContent = () => (
  <div className='flex gap-1 mt-4 flex-wrap text-sm items-center justify-center lg:gap-4'>
    <LegendItem color='#2662D9' label='CMS' />
    <LegendItem color='#8EC6FF' label='Equal to CMS' />
    <LegendItem color='#16a34a' label='↑ Above CMS' />
    <LegendItem color='#dc2626' label='↓ Below CMS' />
  </div>
);
    ...
    <div className='rounded-md border bg-background p-3 shadow-sm'>
      ...
      <ul className='space-y-1 text-sm'>
        <li className='flex items-center justify-between'>
          ...
          <span className='text-[#2662D9]'>{data.cms}</span>
        </li>
        <li className='flex items-center justify-between'>
